...
beast::http::response<beast::http::string_body> not_found(beast::http::request<beast::http::string_body> &&req)
{
...
beast::http::response<beast::http::string_body> server_error(beast::http::request<beast::http::string_body> &&req,
...
beast::http::response<beast::http::string_body> range_not_satisfiable(
    beast::http::request<Body, beast::http::basic_fields<Allocator>> &&req, size_t size)
{
...
template <class Body, class Allocator>
beast::http::response<beast::http::file_body> partial_content(
    beast::http::request<Body, beast::http::basic_fields<Allocator>> &&req, beast::http::file_body::value_type &&body,
