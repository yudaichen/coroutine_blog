                                   ...
                                   std::variant<std::map<std::string, std::string>> &params)
{
    ...
    co_await database->blog_mapper->get_articles_by_column_id_awaitable(std::stoull(id), std::stoi(page),
                                                                        std::stoi(page_size), blogs);
                                          ...
                                          std::variant<std::map<std::string, std::string>> &params)
{
    ...
    std::vector<fast::entity::BlogArticle> blogs;
    co_await database->blog_mapper->get_articles_full_text_awaitable(blog_full_text, std::stoi(page),
                                                                     std::stoi(page_size), blogs);
