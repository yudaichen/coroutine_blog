...
export namespace fast::util
{
    ...
    public:
        ...
        explicit OnceToken(std::nullptr_t, task onDestructed = nullptr) { _onDestructed = std::move(onDestructed); }
    ...
    std::string as_string(std::string_view view) { return std::string(view); }

    bool is_utf8_starter(char c) { return (c & 0x80) != 0 && (c & 0x40) != 0; }
