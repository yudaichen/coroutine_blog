...
#include "../src/common/async_mutex.hpp"
...
TEST(asio_mutex,"async_mutex_lock") {
    avast::asio::async_mutex mutex;
    const auto testFunc = [&mutex]() -> asio::awaitable<void> {
...
TEST(asio_mutex,"async_scoped_lock (simple)") {
    TestThread thread;
    EventLog eventLog;
    avast::asio::async_mutex mutex;
...
TEST(asio_mutex,"async_lock (simple)") {
    TestThread thread;
    EventLog eventLog;
    avast::asio::async_mutex mutex;
...
TEST(asio_mutex,"async_lock (multiple coroutines)") {
    TestThread thread;
    EventLog eventLog;
    avast::asio::async_mutex mutex;
...
TEST(asio_mutex,"async_lock (shallow stack)") {
    TestThread thread;
    EventLog eventLog;
    avast::asio::async_mutex mutex;
...
TEST(asio_mutex,"async_lock (deep stack)") {
    TestThread thread;
    EventLog eventLog;
    avast::asio::async_mutex mutex;
...
TEST(asio_mutex,"async_lock (multithreaded)") {
    EventLog eventLog;
    avast::asio::async_mutex mutex;
...
TEST(asio_mutex,"async_scoped_lock") {
    avast::asio::async_mutex_lock lock;
    REQUIRE_FALSE(lock.owns_lock());
}

TEST(asio_mutex,"async_scoped_lock move init") {
...
TEST(asio_mutex,"async_scoped_lock move assignment") {
    const auto testFunc = []() -> asio::awaitable<void> {
        avast::asio::async_mutex_lock lock;
        REQUIRE_FALSE(lock.owns_lock());
...
TEST(asio_mutex,"async_scoped_lock swap") {
    const auto testFunc = []() -> asio::awaitable<void> {
        avast::asio::async_mutex mutex1;
        avast::asio::async_mutex mutex2;
